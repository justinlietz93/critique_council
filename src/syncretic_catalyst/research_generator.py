...
def generate_ai_proposal(model: str = "claude") -> None:
    ...
    try:
        if model.lower() == "claude":
            ...
            messages = [
                {"role": "system", "content": "You are an expert software engineer and technical writer specializing in creating practical, step-by-step implementation guides that focus on building and creation rather than theory."},
            ...
            # Call the run method directly with messages
            ai_response = deepseek.run(messages, max_tokens=20000)
